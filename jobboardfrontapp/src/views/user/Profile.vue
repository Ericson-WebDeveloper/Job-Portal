<template>
    <div id="profile-user">
                ...
                <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                        ...
                        <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                            <div class="p-4 md:p-12 text-center lg:text-left">
                                ...
                                <div @click="imageEdit = !imageEdit" class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover 
                                bg-center cursor-pointer" :style="`${imageUrl(image)}`"></div>
                                ...
                                <div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
                                    <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                                        ...
                                        viewBox="0 0 20 20"><path d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 
                                        2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z"/></svg> {{ users.detail.current_job }}</p>
                                    ...
                                    {{ users.detail.address }}</p>
                                    <p class="pt-8 text-sm">Totally optional short description about yourself, what you do and so on.</p>

                                <div class="pt-12 pb-8 space-x-2 space-y-2">
                                    <button @click="profileView = !profileView" class="bg-yellow-700 hover:bg-yellow-900 text-white font-bold py-2 px-4 rounded-full">
                                        View Profile
                                    </button> 
                                    <button @click="viewJobExperience" class="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
                                        View Job Exp:
                                    </button> 
                                    <button @click="profileEdit = !profileEdit" class="bg-blue-700 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded-full">
                                        Edit Profile
                                    </button> 
                                    <button  @click="jobExpEdit = !jobExpEdit" class="bg-indigo-700 hover:bg-indigo-900 text-white font-bold py-2 px-4 rounded-full">
                                        Edit Job
                                    </button> 
                                    <button @click="passwordEdit = !passwordEdit" class="bg-red-700 hover:bg-red-900 text-white font-bold py-2 px-4 rounded-full">
                                        Edit Password
                                    </button> 
                                </div>
                        ...
                        <!--Img Col-->
                        <div class="w-full lg:w-2/5 cursor-pointer" @click="imageEdit = !imageEdit">
        ...
        <!-- Modal View Profile Form -->
           <div class="h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-black bg-opacity-50" :class="[profileView ? '' : 'hidden']">
                <div class="bg-white rounded shadow-lg w-4/5 lg:w-2/5 my-auto">
                    <div class="flex justify-between border-b px-4 py-2 ">
                        <h1 class="text-2xl font-bold font-serif">My Profile</h1>
                        <svg @click="profileView = !profileView" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-red-600 cursor-pointer hover:bg-gray-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="m-auto">
                        <div>
                            ...
                            <div class="mt-2 bg-white rounded-lg shadow">
                                ...
                                <div class="px-5 pb-5">
                                    <img :src="users.detail.image" class="mx-auto w-64 h-64" alt="">
                                    <input  placeholder="Name" :value="users.name" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                    ...
                                    <div class="flex flex-col md:flex-row">
                                        <div class="w-full md:flex-grow md:w-2/4 md:pr-2">
                                            <input  placeholder="Email" :value="users.email" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                        ...
                                        <div class="w-full md:flex-grow md:w-2/4">
                                            <input placeholder="age" :value="users.detail.age" class="  text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                            transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  
                                            focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline 
                                            focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                        </div>
                                    ...
                                    <div class="flex flex-col md:flex-row">
                                        <div class="w-full md:flex-grow md:w-2/4 md:pr-2">
                                            <input  placeholder="Course" :value="users.detail.course" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                            transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 
                                            focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                        </div>
                                        <div class="w-full md:flex-grow md:w-2/4">
                                            <input placeholder="College" :value="users.detail.college" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                            transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 
                                            focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                        </div>
                                    </div>
                                    <input  placeholder="Job" :value="users.detail.current_job" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                    transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 
                ...
                <div class="flex justify-end items-center w-100 border-t p-3 space-x-5">
                    <button class="bg-red-500 p-2 rounded text-white hover:bg-red-600" @click="profileView = !profileView">Cancel</button>
           ...
           <div class="h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-black bg-opacity-50" :class="[profileEdit ? '' : 'hidden']">
                        ...
                        <div>
                            ...
                            <div class="mt-2 bg-white rounded-lg shadow">
                                ...
                                <div class="px-5 pb-5">
                                    ...
                                    <input  placeholder="Name" v-model="users.name" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition 
                                    ...
                                    <div class="flex flex-col md:flex-row">
                                        <div class="w-full md:flex-grow md:w-2/4 md:pr-2">
                                            <input  placeholder="Email" v-model="users.email" class="text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                            transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 
                                        ...
                                        <div class="w-full md:flex-grow md:w-2/4">
                                            <input placeholder="age" v-model="users.detail.age" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                            transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200 
                                            focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline 
                                            focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                        </div>
                                    ...
                                    <div class="flex flex-col md:flex-row">
                                        <div class="w-full md:flex-grow md:w-2/4 md:pr-2">
                                            <input  placeholder="Course" v-model="users.detail.course" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                        </div>
                                        <div class="w-full md:flex-grow md:w-2/4">
                                            <input placeholder="College" v-model="users.detail.college" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                        </div>
                                    </div>
                                    <input placeholder="Address" v-model="users.detail.address" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition 
                                    duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white 
                                    dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                    <div id="errors1">
            ...
            <!-- Modal View Job Form -->
           <div class="h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-black bg-opacity-50" :class="[jobExpView ? '' : 'hidden']">
                <div class="bg-white rounded shadow-lg w-4/5 lg:w-2/5 my-auto">
                    <div class="flex justify-between border-b px-4 py-2 ">
                        <h1 class="text-2xl font-bold font-serif">My Job Experience:</h1>
                        <svg @click="jobExpView = !jobExpView" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-red-600 cursor-pointer hover:bg-gray-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                        </svg>
                    </div>
                    ...
                    <div class="m-auto">
                        <div>
                            ...
                            <div class="mt-2 bg-white rounded-lg shadow">
                                ...
                                <div class="px-5 pb-5">
                                    <input  placeholder="Current Job" :value="users.detail.current_job" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                    transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 
                                    focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current 
                                    ring-offset-2 ring-gray-400">
                                    <div class="flex flex-col md:flex-row" v-for="(exp, index) in users.detail.experience" :key="index">
                                        <div class="w-full md:flex-grow md:w-2/4 md:pr-2">
                                            <input  placeholder="Position" :value="exp.position" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                            transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 
                                            focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current 
                                            ring-offset-2 ring-gray-400"></div>
                                        <div class="w-full md:flex-grow md:w-2/4">
                                            <input placeholder="Company" :value="exp.company" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                            transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 
                                            focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current 
                                            ring-offset-2 ring-gray-400"></div>
                                    </div>
                ...
                <div class="flex justify-end items-center w-100 border-t p-3 space-x-5">
                    <button class="bg-red-500 p-2 rounded text-white hover:bg-red-600" @click="jobExpView = !jobExpView">Cancel</button>
                    <!-- <button class="bg-blue-500 p-2 rounded text-white hover:bg-blue-600">Submit</button> -->
                </div>
             </div>
           </div>
           ...
           <div class="h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-black bg-opacity-50" :class="[jobExpEdit ? '' : 'hidden']">
                    ...
                    <div class="m-auto">
                        <div>
                            ...
                            <div class="mt-2 bg-white rounded-lg shadow">
                                ...
                                <div class="px-5 pb-5">
                                    <input  placeholder="Current Job" v-model="users.detail.current_job" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                    transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 
                                    focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current 
                                    ring-offset-2 ring-gray-400">
                                    ...
                                    <div class="flex flex-col md:flex-row" v-for="(exp, index) in users.detail.experience" :key="index">
                                        ...
                                        <div class="w-full md:flex-grow md:w-2/4">
                                            <input placeholder="Company"  v-model="exp.company" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base 
                                            transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 
                                            focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current 
                                             ring-offset-2 ring-gray-400">
                                        </div>
                ...
                <div class="flex justify-end items-center w-100 border-t p-3 space-x-5">
                    ...
                    <button type="buttom" @click.prevent="UpdatingJobExp()" class="bg-blue-500 p-2 rounded text-white hover:bg-blue-600">Submit</button>
                </div>
             </div>
           </div>
           ...
           <div class="h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-black bg-opacity-50" :class="[passwordEdit ? '' : 'hidden']">
                <div class="bg-white rounded shadow-lg w-4/5 lg:w-2/5 my-auto">
                    <div class="flex justify-between border-b px-4 py-2 ">
                        ...
                        <svg @click="passwordEdit = !passwordEdit" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-red-600 cursor-pointer hover:bg-gray-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                        </svg>
                    </div>
                ...
                <div class="flex justify-end items-center w-100 border-t p-3 space-x-5">
                    <button class="bg-red-500 p-2 rounded text-white hover:bg-red-600" @click="passwordEdit = !passwordEdit">Cancel</button>
           ...
           <div class="h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-black bg-opacity-50" :class="[imageEdit ? '' : 'hidden']">
                <div class="bg-white rounded shadow-lg w-4/5 lg:w-2/5 my-auto">
                    <div class="flex justify-between border-b px-4 py-2 ">
                        ...
                        <svg @click="imageEdit = !imageEdit" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-red-600 cursor-pointer hover:bg-gray-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                        </svg>
                    </div>
                ...
                <div class="flex justify-end items-center w-100 border-t p-3 space-x-5">
                    <button class="bg-red-500 p-2 rounded text-white hover:bg-red-600" @click="imageEdit = !imageEdit">Cancel</button>
...
export default {
    setup() {
        ...
        const AddNewField = () => {
            users.value.detail.experience.push({position: '', company: ''})
        }
        ...
        const RemoveField = (index) => {
            ...
            users.value.detail.experience.splice(index, 1);
        }
        ...
        const UpdatingJobExp = async () => {
            let errorBox = document.getElementById("errors2");
            errorBox.innerHTML = '';
            try {
                store.commit('Loading', true);
                const data = {
                    current_job: users.value.detail.current_job,
                    experience: users.value.detail.experience
                }
        ...
        const UpdatingProfile = async () => {
            ...
            try {
                const data = {
                    ...
                    age: users.value.detail.age,
                    address: users.value.detail.address,
                    college: users.value.detail.college,
                    course: users.value.detail.course,
                }
                store.commit("Loading", true);
                ...
                //         </div>`;
                //     }).join("");
                //     document.getElementById("errors1").innerHTML = html
                // } else {
                //     Swal.fire({
                //         position: 'top-end',
                //         icon: 'error',
        ...
        onMounted(() => {
            let {detail} = store.getters['user/GET_USER_DATA'];
            image.value = detail.image;
        });

        const viewJobExperience = async() => {
            users.value.detail.experience.value = [];
            try {
                store.commit("Loading", true);
                await store.dispatch('auth/GET_USER');
                store.commit("Loading", false);
                jobExpView.value = !jobExpView.value;
            } catch (error) {
                store.commit("Loading", false);
                Swal.fire({
                    position: 'center',
                    icon: 'error',
                    title: 'Cannot Get Job Exp: Data',
                    showConfirmButton: true,
                });
            }
        ...
        return {
            profileView, jobExpView, profileEdit, jobExpEdit, passwordEdit, imageEdit, image, imageUrl, users, AddNewField, RemoveField,
            viewJobExperience, UpdatingProfile, UpdatingJobExp, password, UpdatingPass, imageProfile, ImageCapture, UpdateImage
        }
    }
}
</script>